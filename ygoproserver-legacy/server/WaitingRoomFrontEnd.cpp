...
bool WaitingRoom::send_challenge_request(DuelPlayer* dp,wchar_t * second,unsigned char mode)
{
		...
		bool ranked1 = (dp->loginStatus == Users::AUTHENTICATED || dp->loginStatus == Users::NOPASSWORD);
		bool ranked2 = (dpnemico->loginStatus == Users::AUTHENTICATED || dpnemico->loginStatus == Users::NOPASSWORD);
		if(ranked1 != ranked2)
		{
