...
void Users::updateSkill(std::vector<LoggerPlayerInfo *>  nomi, int risultato)
{
...
void Users::saveDuelResult(std::vector<LoggerPlayerInfo *> nomi, int risultato,std::string replay)
{
